...
class ViewController: UIViewController {
    ...
    var wordArray = ["STARFISH", "SHARK", "WHALE", "FISH", "PENGUINS", "OCTOPUS", "SEAL", "TURTLE", "SEABIRDS", "SEAHORSE", "WALRUS", "SQUID", "CLAM", "SHRIMP", "CRAB","JELLYFISH", "SHELL", "OYSTER", "OTTER", "LOBSTER"]
