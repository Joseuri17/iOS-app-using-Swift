...
class space: UIViewController {
    ...
    var wordArray = ["SUN", "STARS", "BLACKHOLE", "EARTH", "NEPTUNE", "PLUTO", "JUPITER", "MERCURY", "SATURN", "NEBULA", "LIGHT", "GIANTSUN", "DWARFS", "VENUS", "MARS","MILKYWAY", "GALAXY", "SPACE", "URANIUS", "STARLIGHT"]
