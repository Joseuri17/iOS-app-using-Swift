...
class reptiles: UIViewController {
    ...
    var wordArray = ["LIZARD", "SNAKE", "IGUANA", "GECKO", "PYTHON", "CROCODILE", "ALLIGATOR", "VIPER", "COBRA", "TORTOISE", "BOA", "AGAMID", "COLUBIRD", "GHARIAL", "RATTLESNAKE","SEASNAKE", "MAMBA", "SKINK", "PLASTRON", "COBRA"]
    ...
    @IBAction func hint(_ sender: Any) {
        let letter = word.randomElement()
        guessField.text = String(letter!)
